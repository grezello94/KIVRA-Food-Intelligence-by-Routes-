const CACHE='kivra-shell-v36';const SHELL=['/','/index.html','/app.css','/printer.css','/visual-refresh.css','/assets/kitchen-food-sprite-v2.jpg','/assets/kivra-by-routes-logo.png','/app.js','/manifest.webmanifest'];
