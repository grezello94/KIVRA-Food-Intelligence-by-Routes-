const CACHE='kivra-shell-v38';const SHELL=['/','/index.html','/app.css','/printer.css','/visual-refresh.css','/assets/kitchen-food-sprite-v2.webp','/assets/kivra-by-routes-logo.webp','/app.js','/manifest.webmanifest'];
