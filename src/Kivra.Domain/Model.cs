...
public sealed class PrintJob : Entity { public Guid LabelId { get; set; } public Label? Label { get; set; } public Guid PrinterId { get; set; } public Guid RequestedByUserId { get; set; } public DateTimeOffset RequestedAt { get; set; } = DateTimeOffset.UtcNow; public DateTimeOffset? StartedAt { get; set; } public DateTimeOffset? CompletedAt { get; set; } public PrintJobStatus Status { get; set; } = PrintJobStatus.Queued; public string? FailureReason { get; set; } public int RetryCount { get; set; } public bool IsReprint { get; set; } public string? Payload { get; set; } public string? IdempotencyKey { get; set; } public Guid? BridgeDeviceId { get; set; } public DateTimeOffset? LeaseExpiresAt { get; set; } }
public sealed class BridgeDevice : Entity { public required string Name { get; set; } public required string TokenHash { get; set; } public bool Active { get; set; } = true; public DateTimeOffset? LastSeenAt { get; set; } public string? AppVersion { get; set; } public string? Platform { get; set; } public DateTimeOffset? RevokedAt { get; set; } }
public sealed class BridgePairingCode : Entity { public required string CodeHash { get; set; } public DateTimeOffset ExpiresAt { get; set; } public DateTimeOffset? UsedAt { get; set; } public Guid CreatedByUserId { get; set; } }
